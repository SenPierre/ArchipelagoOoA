...
DEFINES = {
    ...
    "TREASURE_CUCCODEX":"$55",
    "TREASURE_LON_LON_EGG":"$56",
    "TREASURE_GHASTLY_DOLL":"$57",
    "TREASURE_IRON_POT":"$35",
    "TREASURE_LAVA_SOUP":"$38",
    "TREASURE_GORON_VASE":"$39",
    "TREASURE_FISH":"$3a",
    "TREASURE_MEGAPHONE":"$3b",
    "TREASURE_MUSHROOM":"$3c",
    "TREASURE_WOODEN_BIRD":"$3d",
    "TREASURE_ENGINE_GREASE":"$3e",
    "TREASURE_PHONOGRAPH":"$3f",
